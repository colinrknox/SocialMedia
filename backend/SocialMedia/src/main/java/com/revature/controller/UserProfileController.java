...
public class UserProfileController {
	...
	/***
	 * Authenticates a user's credentials by comparing them with the stored credentials in the
	 * database.
	 * @param req the request object to get the session variable
	 * @param json the form values in a key: value pair object
	 * @return HttpStatus.OK with the UserProfile object in the body as JSON on success
